...
-- =================================================================
-- Entidad PersonaFisica (Hereda de ResponsableDePago - MappedSuperclass)
-- Tabla: persona_fisica
-- Columnas: id_persona_fisica (Serial), estado_persona_fisica (Boolean)
...
-- =================================================================
-- Entidad PersonaJuridica (Hereda de ResponsableDePago - MappedSuperclass)
-- Tabla: persona_juridica
-- Columnas:
--   cuit (PK, String, 11 chars)
--   razon_social (String, 100 chars)
--   telefono (String, 20 chars)
--   estado_persona_juridica (Boolean)
--   calle, numero, piso, departamento, codigo_postal, localidad, provincia (De @Embedded Direccion)
